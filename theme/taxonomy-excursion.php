...
$parent = get_top_parent_category($category_id);
set_query_var('sidebar_term', $parent);
get_header();
?>
		...
		<div class="container">
			...
			<div class="pt-6 sm:pt-12 pb-[64px]">
				...
				<div class="buttons relative flex justify-end gap-2 items-center">
					<div class="swiper-button-prev w-[61px] h-[61px] p-0"></div>
					<div class="swiper-button-next w-[61px] h-[61px] p-0"></div>
				</div>
				<div class="swiper_gids overflow-hidden px-[2px] pt-[2px] mb-5 sm:mb-8">
					<div class="swiper-wrapper flex h-auto py-[10px]">
						<div class="swiper-slide rounded-[6px] shadows_custom overflow-hidden">
							<img src="https://flagmanspb.aristoff.ru/wp-content/uploads/2024/12/krepost-oreshek-vnutri-768x519.jpeg" class="h-[255px]" alt="">
							<div class="p-6">
								<div class="font-bold text-[20px] mb-1">Богданова Рената Халимовна</div>
								<div class="text-[#6B7280]">Опыт работы: с 2016 года </div>
							</div>
						</div>
						<div class="swiper-slide rounded-[6px] shadows_custom overflow-hidden">
							<img src="https://flagmanspb.aristoff.ru/wp-content/uploads/2024/12/krepost-oreshek-vnutri-768x519.jpeg" class="h-[255px]" alt="">
			...
			<div class="pt-3 sm:pt-12 pb-[30px] sm:pb-[64px]">
				...
				<div class="swiper_rev overflow-hidden px-[2px] pt-[2px] mb-8">
					<div class="swiper-wrapper flex h-auto py-[10px]">
						<div class="swiper-slide rounded-[6px] shadows_custom p-6 text-[14px] sm:text-[16px]">
							<div class="text-[14px]">Иванов Иван</div>
							<div class="text-[14px] text-[#6B7280] mb-3">21 дек, 2024</div>
							<div class="mb-3 text-[#111827]">Был на экскурсии «Мифы и Легенды», очень понравилось. За три часа вы узнаете о городе то, что не пишут в путеводителях и популярных изданиях...</div>
							<div class="text-[#52A6B2] cursor-pointer">Читать весь отзыв</div>
							<div class="mt-4 font-bold text-[#52A6B2]">Экскурсия: «Экскурсия в Царское село
								с посещением Екатерининского дворца с Янтарной комнатой и...»</div>
				...
				<div class="text-center">
					<a href="#" class="inline-flex h-11 items-center justify-center font-bold  px-10 rounded-md bg-[#52A6B2] text-white text-[12px] lg:text-sm">Посмотреть все отзывы</a>
				</div>
			</div>

			<div class="pt-8 sm:pt-12 pb-[10px] sm:pb-[64px]">
				<h2 class="mb-8 sm:mb-12">
					Рекомендуем посетить <br>
					в Санкт-Петербурге
				</h2>

				<div class="swiper overflow-hidden px-[2px] pt-[2px] mb-8">
					<div class="swiper-wrapper flex h-auto py-[10px]">
						<div class="swiper-slide rounded-[6px] shadows_custom overflow-hidden relative h-[255px]">
							<img src="https://flagmanspb.aristoff.ru/wp-content/uploads/2024/12/krepost-oreshek-vnutri-768x519.jpeg" alt="" class="absolute inset-0 w-full h-full object-cover z-[-1]">
							<div class="absolute  top-[100px] bottom-0 right-0 left-0 bg-gradient-to-b from-transparent to-[#E0CB97] opacity-80 z-0"></div>
							<div class="absolute text-white left-6 bottom-6 right-6">
                                    <span class="sm:text-[20px] font-bold leading-[1.6] sm:leading-[1.3]">Экскурсия в Царское село
                                        с посещением Екатерининского дворца с Янтарной комнатой
                                        и парка</span>
						...
						<div class="swiper-slide rounded-[6px] shadows_custom overflow-hidden relative h-[255px]">
							<img src="https://flagmanspb.aristoff.ru/wp-content/uploads/2024/12/krepost-oreshek-vnutri-768x519.jpeg" alt="" class="absolute inset-0 w-full h-full object-cover z-[-1]">
							<div class="absolute  top-[100px] bottom-0 right-0 left-0 bg-gradient-to-b from-transparent to-[#E0CB97] opacity-80 z-0"></div>
							<div class="absolute text-white left-6 bottom-6 right-6 z-[1]">
								<span class="text-[20px] font-bold">Обзорная</span>
								<span>от 1 500 ₽/чел</span>
							</div>
						</div>
						<div class="swiper-slide rounded-[6px] shadows_custom overflow-hidden relative h-[255px]">
				...
				<div class="entry-content">
					<p>Познакомьтесь с Северной столицей, выбрав одну из наших обзорных автобусных экскурсий. Вы проедете по историческим местам, увидите знаменитые достопримечательности, такие как Исаакиевский собор, Зимний дворец и величественные храмы, которые стали символами Петербурга. Для тех, кто хочет почувствовать атмосферу города с воды, мы предлагаем прогулки на катере, где перед вами откроются самые красивые виды и развод мостов, который неизменно восхищает туристов.</p>
					<p>Наши экскурсии по городу подойдут как для тех, кто впервые в Петербурге, так и для его постоянных гостей. Вы узнаете интересные факты о жизни жителей, погрузитесь в мистические легенды и посетите музеи, рассказывающие об истории и культуре города. Каждый маршрут продуман до мелочей, чтобы каждая минута была наполнена открытием нового.</p>
					<p> Санкт-Петербург — это город, где прошлое и настоящее гармонично переплетаются. Уникальная архитектура, богатое культурное наследие и живописные виды делают его обязательным для посещения. Выберите экскурсию по душе и откройте для себя этот удивительный город во всей его красоте!</p>
				</div>
			</div>

			<div class="pt-8 sm:pt-12 pb-[10px] sm:pb-[30px]">
				<h2 class="mb-8 sm:mb-12">
					Что посетить за пределами <br>
					Петербурга?
				</h2>
				...
				<div class="swiper overflow-hidden px-[2px] pt-[2px] mb-8 lg:hidden">
					<div class="swiper-wrapper flex h-auto py-[10px]">
						<div class="swiper-slide rounded-[6px] shadows_custom overflow-hidden relative h-[255px]">
							...
							<div class="absolute text-white left-6 bottom-6 right-6">
                                    <span class="text-[20px] font-bold">Экскурсия в Царское село
                                        с посещением Екатерининского дворца с Янтарной комнатой
                                        и парка</span>
								<span>от 1 500 ₽/чел</span>
							</div>
				...
				<div class="grid-layout hidden lg:grid grid-cols-12 gap-4  mb-8">
					...
					<div class="col-span-4 rounded-[6px] shadows_custom overflow-hidden relative h-[255px]">
						<img src="https://flagmanspb.aristoff.ru/wp-content/uploads/2024/12/krepost-oreshek-vnutri-768x519.jpeg" alt="" class="absolute inset-0 w-full h-full object-cover">
						<div class="absolute top-[100px] bottom-0 right-0 left-0 bg-gradient-to-b from-transparent to-[#52a6b2] opacity-80 z-0"></div>
						<div class="absolute text-white left-6 bottom-6 right-6">
							<div class="text-[20px] font-bold">Карелия</div>
							<div>от 1 500 ₽/чел</div>
						</div>
						<div class="absolute right-6 bottom-6">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/charch.svg" alt="">
						</div>
					</div>
					<div class="col-span-4 rounded-[6px] shadows_custom overflow-hidden relative h-[255px]">
						<img src="https://flagmanspb.aristoff.ru/wp-content/uploads/2024/12/krepost-oreshek-vnutri-768x519.jpeg" alt="" class="absolute inset-0 w-full h-full object-cover">
					...
					<div class="col-span-6 rounded-[6px] shadows_custom overflow-hidden relative h-[255px]">
						<img src="https://flagmanspb.aristoff.ru/wp-content/uploads/2024/12/krepost-oreshek-vnutri-768x519.jpeg" alt="" class="absolute inset-0 w-full h-full object-cover">
						<div class="absolute top-[100px] bottom-0 right-0 left-0 bg-gradient-to-b from-transparent to-[#52a6b2] opacity-80 z-0"></div>
						<div class="absolute text-white left-6 bottom-6 right-6">
							<div class="text-[20px] font-bold">Карелия</div>
				...
				<div class="entry-content">
					<p>Пригороды Петербурга славятся своим великолепием. В Екатерининском дворце в Пушкине вы сможете увидеть знаменитую Янтарную комнату, а Гатчинский дворцово-парковый ансамбль удивит своей атмосферой уединения и историческими интерьерами. Петергоф порадует гостей каскадами фонтанов и видами на Финский залив, а Кронштадт откроет величие Морского собора и старинные форты.</p>

					<p>Любителям архитектуры и истории обязательно стоит посетить Выборг с его средневековым шармом и замком, расположенным на живописных островах. Каждый маршрут дарит уникальные впечатления и погружает в богатую историю региона.</p>
				</div>
			</div>

			<div class="pt-8 sm:pt-12 pb-[40px] sm:pb-[64px]">
				<h2 class="mb-8 sm:mb-12">
					Экскурсии <br>
					дальнего следования
				</h2>
				...
				<div class="swiper overflow-hidden px-[2px] pt-[2px] mb-8">
					<div class="swiper-wrapper flex h-auto py-[10px]">
						<div class="swiper-slide rounded-[6px] shadows_custom overflow-hidden relative h-[255px]">
							...
							<div class="absolute  top-[100px] bottom-0 right-0 left-0 bg-gradient-to-b from-transparent to-[#E0CB97] opacity-80 z-0"></div>
							<div class="absolute text-white left-6 bottom-6 right-6">
								<span class="text-[20px] font-bold">Карелия</span>
								<span>от 1 500 ₽/чел</span>
							</div>
						</div>
						<div class="swiper-slide rounded-[6px] shadows_custom overflow-hidden relative h-[255px]">
							...
							<div class="absolute  top-[100px] bottom-0 right-0 left-0 bg-gradient-to-b from-transparent to-[#E0CB97] opacity-80 z-0"></div>
							<div class="absolute text-white left-6 bottom-6 right-6 z-[1]">
								<span class="text-[20px] font-bold">Новгород</span>
								<span>от 1 500 ₽/чел</span>
							</div>
						</div>
						<div class="swiper-slide rounded-[6px] shadows_custom overflow-hidden relative h-[255px]">
							...
							<div class="absolute  top-[100px] bottom-0 right-0 left-0 bg-gradient-to-b from-transparent to-[#E0CB97] opacity-80 z-0"></div>
							<div class="absolute text-white left-6 bottom-6 right-6 z-[1]">
								<span class="text-[20px] font-bold">Псков</span>
								<span>от 1 500 ₽/чел</span>
							</div>
						</div>
					</div>
				...
				<div class="entry-content">
					<p>В поездке по Карелии вас ждут захватывающие пейзажи, мраморный каньон Рускеала и удивительная природа региона. Псковская область порадует древними крепостями и монастырями, а в Новгороде вы погрузитесь в историю Древней Руси, посетив его знаменитый кремль и соборы.
						Каждый тур разработан с заботой о комфорте путешественников и включает посещение ключевых достопримечательностей регионов. Это отличная возможность увидеть другую Россию, познакомиться с её богатой историей и культурным наследием.</p>
				</div>
			</div>
				...
				<div class="entry-content col-span-12 lg:col-span-6 order-1 sm:order-2">
					...
					<details class="details w-full relative block mb-4" name="faq" open="">
						...
						<div class="details__content ps-4 pe-14 lg:ps-8 pb-6 lg:pb-7 text-[#6B7280]">
							<p>Наши экскурсии подходят для школьников разного возраста — от дошкольников с 4 до подростков 17 лет. Мы адаптируем программы под интересы и уровень восприятия детей, чтобы каждая экскурсия была увлекательной и познавательной. Для дошкольников (4-6 лет) мы предлагаем программы с элементами игры и мультимедиа. Для младших школьников (7-10 лет) — интерактивные экскурсии с мастер-классами и занимательными фактами. Для старших школьников и подростков (11-17 лет) — более глубокие и тематические программы, которые включают театрализованные элементы и участие в экспериментах.</p>
						</div>
					</details>
					...
					<details class="details w-full relative block mb-4" name="faq">
						<summary class="details__title py-4 ps-4 lg:ps-8 pe-[60px] xs:pe-14 sm:pe-10 text-[#111827] font-bold cursor-pointer list-none">
							Какие документы нужны для детской экскурсии?									</summary>
						<div class="details__content ps-4 pe-14 lg:ps-8 pb-6 lg:pb-7 text-[#6B7280]">

							<p>Мы берем на себя все организационные вопросы, включая подачу уведомления в ГИБДД. Эта услуга уже включена в стоимость экскурсии. От вас потребуется только предоставить список пассажиров — фамилии, имена, возраст детей и сопровождающих.</p>
						</div>
					</details>
